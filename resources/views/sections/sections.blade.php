                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <div class="col-sm-5 col-md-3 col-xl-2">
                                <button class="modal-effect btn btn-primary btn-rounded btn-block"
                                    data-effect="effect-scale" data-toggle="modal" href="#modaldemo8"><i
                                        class="fas fa-plus"></i>اضافة قسم</button>
                            </div>
                        </div>
                        <div class="card-body">
