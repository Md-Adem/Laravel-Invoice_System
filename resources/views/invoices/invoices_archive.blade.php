...
@endsection
@section('content')
    @if (session()->has('archive_destroy'))
        <script>
    ...
    @endif
    @if (session()->has('archive_restore'))
        <script>
            window.onload = function() {
                notif({
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('archive_destroy', 'test') }}" method="get">
                        {{ method_field('') }}
                        {{ csrf_field() }}
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('archive_restore') }}" method="PATCH">
                        {{ method_field('') }}
                        {{ csrf_field() }}
                </div>
                <div class="modal-body">
